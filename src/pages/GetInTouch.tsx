...
import data from '../data/getintouch.json'
      ...
      <main id={style.main}>
        <div className="container">
          ...
          <article className='row ms-lg-5 ps-lg-5 mt-lg-3'>
            ...
            <h2 className='mb-0' id={style.h2}>There for you and <span id={style.span}>care for you</span> ...</h2>
              ...
              <p id={style.p}>But i must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and i will give you a complete account of the system, and expound all actual teachings of the great explorer of the truth, the master-builder of human happiness. </p>
            
               
            <ModalComponent />

              <div className='row justify-content-end p-1 mt-5  '>
              <p  className='text-bg-dark  mt-5 col-lg-3 text-center p-2 pt-0 pb-0 d-none d-lg-block' 
                  id={style.headliner}>GetInTouch</p>
              </div>
